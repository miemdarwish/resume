      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mb-6 text-base leading-relaxed text-foreground/80 sm:text-lg">{t.services.intro}</p>
            <p className="mb-6 leading-relaxed text-muted-foreground">{t.services.body1}</p>
            <p className="mb-8 leading-relaxed text-muted-foreground">{t.services.body2}</p>
